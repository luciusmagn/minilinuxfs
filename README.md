...
Pozn 1: U pole install lze v příkazech využít hodnotu '\<\<target\>\>', která reprezentuje
...
V základní konfiguraci stáhne MiniLinuxFS 6 repozitářů:
**sbase**, **ubase**, **9base**, **bash-static**, **find-static** a **coreutils-static**. Z nich využívá jen některé programy:

| sbase*                              | ubase                             | 9base                           | coreutils                        |
|-------------------------------------|-----------------------------------|---------------------------------|----------------------------------|
| <ul><li>[ ] basename</li></ul>      | <ul><li>[ ] chvt</li></ul>        | <ul><li>[ ] ascii</li></ul>     | <ul><li>[x] cp</li></ul>         |
| <ul><li>[ ] cal</li></ul>           | <ul><li>[ ] clear</li></ul>       | <ul><li>[x] awk</li></ul>       | a spousta dalších lol            |
| <ul><li>[x] cat</li></ul>           | <ul><li>[ ] ctrlaltdel</li></ul>  | <ul><li>[ ] basename</li></ul>  | nechce se mi psát                |
| <ul><li>[ ] chgrp</li></ul>         | <ul><li>[ ] dd</li></ul>          | <ul><li>[ ] bc</li></ul>        | dokumentace fujNU coreutils:     |
| <ul><li>[x] chmod</li></ul>         | <ul><li>[ ] df</li></ul>          | <ul><li>[ ] cal</li></ul>       | <https://www.gnu.org/software/coreutils/manual/coreutils.html> |
...
| <ul><li>[ ] cp</li></ul>            | <ul><li>[ ] getty</li></ul>       | <ul><li>[x] diff</li></ul>      |                                  |
